                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="d-flex flex-wrap gap-3 mb-2">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <label for="Invoice1_IN" class="me-2 mb-0" style="width: 80px;">Invoice 1</label>
                                                    <div class="position-relative">
                                                        <input type="text"
                                                               id="Invoice1_IN"
                                                               name="Invoice1_IN"
                                                ...
                                                <!-- Amount 1 -->
                                                <div class="d-flex align-items-center">
                                                    <label for="Amount1_IN" class="me-2 mb-0" style="width: 80px;">Amount 1</label>
                                                    <input type="number"
                                                           id="Amount1_IN"
                                                           name="Amount1_IN"
                                                           class="form-control"
                                            ...
                                            <!-- Row 2: Invoice 2 + Amount 2 -->
                                            <div class="d-flex flex-wrap gap-3">
                                                <!-- Invoice 2 -->
                                                <div class="d-flex align-items-center">
                                                    <label for="Invoice2_IN" class="me-2 mb-0" style="width: 80px;">Invoice 2</label>
                                                    <div class="position-relative">
                                                        <input type="text"
                                                               id="Invoice2_IN"
                                                               name="Invoice2_IN"
                                                ...
                                                <!-- Amount 2 -->
                                                <div class="d-flex align-items-center">
                                                    <label for="Amount2_IN" class="me-2 mb-0" style="width: 80px;">Amount 2</label>
                                                    <input type="number"
                                                           id="Amount2_IN"
                                                           name="Amount2_IN"
                                                           class="form-control"
