                    ...
                    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                        ...
                        <div class="accordion-body">
                            ...
                            <div class="container input-group mb-3 input-group-sm  py-3 row g-3 custom-form">
                                ...
                                <div class="col-md-12 d-flex align-items-center ">
                                    <label for="Quotation_IN" class="me-4" style="width: 100px;">Quotation</label>
                                    <div class="d-flex flex-column ">
                                ...
                                <div class="col-md-12 d-flex align-items-center ">
                                    <label for="PO_Amount_IN" class="me-4" style="width: 100px;">PO Amount</label>
                                    <div class="d-flex flex-column  ">
                                ...
                                <div class="col-md-12 d-flex align-items-center ">
                                    <label for="Banlace_IN" class="me-4" style="width: 100px;">Balance_Invoice</label>
                                    <div class="d-flex flex-column">
                                        @php
                                ...
                                <div class="col-md-6 d-flex align-items-center flex-wrap ">
                                    <div class="d-flex align-items-center mb-3 ">
                                        ...
                                        <label for="Invoice1_IN" class="me-4" style="width: 100px;">Invoice 1 </label>
                                    ...
                                    <div class="d-flex align-items-center mb-3 ms-3">
                                        <label for="Amount1_IN" class="me-4" style="width: 100px;">Amount 1</label>
                                        <div class="d-flex flex-column  ">
                                ...
                                <div class="col-md-6 d-flex align-items-center flex-wrap mt-0 ">
                                    <div class="d-flex align-items-center mb-3 ">
                                        ...
                                        <label for="Invoice2_IN" class="me-4" style="width: 100px;">Invoice 2 </label>
                                        <div class="flex-grow-1 position-relative">
                                    ...
                                    <div class="d-flex align-items-center mb-3 ms-3">
                                        <label for="Amount2_IN" class="me-4" style="width: 100px;">Amount 2 </label>
                                        <div class="d-flex flex-column  ">
                                ...
                                <div class="container input-group mb-3 input-group-sm  py-3 row g-3 custom-form">
                                        ...
                                        <div class="d-flex align-items-center mb-3 ms-2">
                                            ...
                                            <div class="flex-grow-1 position-relative">
                                                <input type="text" id="AssignedSubCSurveySAQ"
                                                    name="AssignedSubCSurveySAQ" class="form-control datepicker pe-5"
                                    ...
                                    <div class="col-md-3 d-flex align-items-center flex-wrap mt-0">
                                        ...
                                        <div class="d-flex align-items-center mb-3 ms-2">
                                            ...
                                            <div class="flex-grow-1 position-relative">
                                                <input type="text" id="Accept_PR_Date_SAQ" name="Accept_PR_Date_SAQ"
                                    ...
                                    <div class="col-md-7 d-flex align-items-center mt-4 ms-2">
                                        ...
                                        <div class="form-group mb-4 ms-2 ">
                                            <label for="Mail_1st_SAQ" class="me-4" style="width: 120px;">Mail</label>
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="ERP_1st_SAQ" class="me-4" style="width: 120px;">ERP</label>
                                            <div class="flex-grow-1 position-relative">
                                    ...
                                    <div class="col-md-7 d-flex align-items-center  ms-2">
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="Mail_2nd_SAQ" class="me-4" style="width: 120px;">Mail</label>
                                            <div class="flex-grow-1 position-relative">
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="ERP_2nd_SAQ" class="me-4" style="width: 120px;">ERP</label>
                                            <div class="flex-grow-1 position-relative">
                                    ...
                                    <div class="col-md-7 d-flex align-items-center  ms-2">
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="Mail_3rd_SAQ" class="me-4" style="width: 120px;">Mail</label>
                                            <div class="flex-grow-1 position-relative">
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="ERP_3rd_SAQ" class="me-4" style="width: 120px;">ERP</label>
                                            <div class="flex-grow-1 position-relative">
                                    ...
                                    <div class="col-md-7 d-flex align-items-center ms-2">
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="Mail_4th_SAQ" class="me-4" style="width: 120px;">Mail</label>
                                            <div class="flex-grow-1 position-relative">
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="ERP_4th_SAQ" class="me-4" style="width: 120px;">ERP</label>
                                            <div class="flex-grow-1 position-relative">
                            ...
                            <div class="accordion-body">
                                ...
                                <div class="container input-group mb-3 input-group-sm  py-3 row g-3 custom-form">
                                    ...
                                    <div class="col-md-6 d-flex align-items-center flex-wrap mt-0 ">
                                        ...
                                        <div div class="d-flex align-items-center mb-3 ms-2">
                                            <label for="PlanCR" class="me-4" style="width: 120px;">PlanCR</label>
                                            <div class="flex-grow-1 position-relative">
                                                <input type="text" id="PlanCR" name="PlanCR"
                                                    class="form-control datepicker pe-5" placeholder="วันที่-เดือน-ปี"
                                                    style="width: 160px;" value="{{ old('PlanCR', $blog->PlanCR) }}">
                                                <i
                                                    class="bi bi-calendar position-absolute top-50 end-0 translate-middle-y pe-2"></i>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center mb-3 ms-2">
                                            ...
                                            <div class="flex-grow-1 position-relative">
                                                <input type="text" id="ActualCR" name="ActualCR"
                                                    class="form-control datepicker pe-5" placeholder="วันที่-เดือน-ปี"
                                                    style="width: 160px;" value="{{ old('ActualCR', $blog->ActualCR) }}">
                                                <i
                                                    class="bi bi-calendar position-absolute top-50 end-0 translate-middle-y pe-2"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-3 d-flex align-items-center flex-wrap mt-0">
                                        ...
                                        <div class="d-flex align-items-center mb-3 ms-2">
                                            <label for="Quo_No_CR" class="me-4" style="width: 120px;">Quo_No_CR</label>
                                            <div class="d-flex flex-column ">
                                        ...
                                        <div class="d-flex align-items-center mb-3 ms-2">
                                            ...
                                            <div class="flex-grow-1 position-relative">
                                                <input type="text" id="Accept_PR_Date_CR" name="Accept_PR_Date_CR"
                                                    class="form-control datepicker pe-5" placeholder="วันที่-เดือน-ปี"
                                                    style="width: 160px;"
                                    ...
                                    <div class="col-md-3 d-flex align-items-center flex-wrap mt-0">
                                        ...
                                        <div class="d-flex align-items-center mb-3 ms-2">
                                            <label for="WO_No_CR" class="me-4" style="width: 120px;">WO_No_CR</label>
                                            <div class="d-flex flex-column ">
                                    ...
                                    <div class="col-md-7 d-flex align-items-center mt-4 ms-2">
                                        ...
                                        <div class="form-group mb-4 ms-2 ">
                                            <label for="Mail_1st_CR" class="me-4" style="width: 120px;">Mail</label>
                                            <div class="position-relative">
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="ERP_1st_CR" class="me-4" style="width: 120px;">ERP</label>
                                            <div class="flex-grow-1 position-relative">
                                    ...
                                    <div class="col-md-7 d-flex align-items-center ms-2">
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="Mail_2nd_CR" class="me-4" style="width: 120px;">Mail</label>
                                            <div class="flex-grow-1 position-relative">
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="ERP_2nd_CR" class="me-4" style="width: 120px;">ERP</label>
                                            <div class="flex-grow-1 position-relative">
                                    ...
                                    <div class="col-md-7 d-flex align-items-center  ms-2">
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="Mail_3rd_CR" class="me-4" style="width: 120px;">Mail</label>
                                            <div class="flex-grow-1 position-relative">
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="ERP_3rd_CR" class="me-4" style="width: 120px;">ERP</label>
                                            <div class="flex-grow-1 position-relative">
                                    ...
                                    <div class="col-md-7 d-flex align-items-center ms-2">
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="Mail_4th_CR" class="me-4" style="width: 120px;">Mail</label>
                                            <div class="flex-grow-1 position-relative">
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="ERP_4th_CR" class="me-4" style="width: 120px;">ERP</label>
                                            <div class="flex-grow-1 position-relative">
                                ...
                                <div class="container input-group mb-3 input-group-sm  py-3 row g-3 custom-form">
                                    ...
                                    <div class="col-md-6 d-flex align-items-center flex-wrap ">
                                        ...
                                        <div class="d-flex align-items-center mb-3 ms-2">
                                            ...
                                            <div class="flex-grow-1 position-relative">
                                                <input type="text" id="AssignedSubCTSSR" name="AssignedSubCTSSR"
                                                    class="form-control datepicker pe-5" placeholder="วันที่-เดือน-ปี"
                                                    style="width: 160px;"
                                    ...
                                    <div class="col-md-6 d-flex align-items-center flex-wrap mt-0 ">
                                        ...
                                        <div class="d-flex align-items-center mb-3 ms-2">
                                            <label for="PlanTSSR" class="me-4" style="width: 120px;">PlanTSSR</label>
                                            <div class="flex-grow-1 position-relative">
                                                <input type="text" id="PlanTSSR" name="PlanTSSR"
                                                    class="form-control datepicker pe-5" placeholder="วันที่-เดือน-ปี"
                                                    style="width: 160px;" value="{{ old('PlanTSSR', $blog->PlanTSSR) }}">
                                                <i
                                                    class="bi bi-calendar position-absolute top-50 end-0 translate-middle-y pe-2"></i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-3 d-flex align-items-center flex-wrap mt-0">
                                        ...
                                        <div class="d-flex align-items-center mb-3 ms-2">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                @else
                                                    @if ($total > $banlace)
                                                        <input type="number" name="Banlace_TSSR" class="form-control"
                                                            value="{{ number_format($difference, 2, '.', '') }}" readonly
                                                            style="color: red">
                                                    @else
                                                        <input type="number" name="Banlace_TSSR" class="form-control"
                                    ...
                                    <div class="col-md-7 d-flex align-items-center mt-4  ms-2">
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="ERP_1st_TSSR" class="me-4" style="width: 120px;">ERP</label>
                                            <div class="flex-grow-1 position-relative">
                                    ...
                                    <div class="col-md-7 d-flex align-items-center  ms-2">
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="ERP_2nd_TSSR" class="me-4" style="width: 120px;">ERP</label>
                                            <div class="flex-grow-1 position-relative">
                                    ...
                                    <div class="col-md-7 d-flex align-items-center  ms-2">
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="ERP_3rd_TSSR" class="me-4" style="width: 120px;">ERP</label>
                                            <div class="flex-grow-1 position-relative">
                                    ...
                                    <div class="col-md-7 d-flex align-items-center ms-2">
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="ERP_4th_TSSR" class="me-4" style="width: 120px;">ERP</label>
                                            <div class="flex-grow-1 position-relative">
                                ...
                                <div class="container input-group mb-3 input-group-sm  py-3 row g-3 custom-form">
                                        ...
                                        <div class="d-flex align-items-center mb-3 ms-2">
                                            ...
                                            <div class="flex-grow-1 position-relative">
                                                <input type="text" id="Assigned_CivilWork"
                                                    ...
                                                    class="form-control datepicker" placeholder="วันที่-เดือน-ปี"
                                        ...
                                        <div class="d-flex align-items-center mb-3 ms-2">
                                            ...
                                            <div class="d-flex flex-column ">
                                                <input type="text" name="SubName_CivilWork" class="form-control"
                                                    style="width: 200px;" value="{{ $blog->SubName_CivilWork }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 d-flex align-items-center flex-wrap mt-0">
                                        <div class="d-flex align-items-center mb-3 ms-2">
                                            ...
                                            <div class="flex-grow-1 position-relative">
                                                <input type="text" id="Plan_CivilWork" name="Plan_CivilWork"
                                        ...
                                        <div class="d-flex align-items-center mb-3 ms-2">
                                            ...
                                            <div class="flex-grow-1 position-relative">
                                                <input type="text" id="Actual_CivilWork" name="Actual_CivilWork"
                                                    style="width: 160px;" class="form-control datepicker"
                                                    placeholder="วันที่-เดือน-ปี"
                                    ...
                                    <div class="col-md-3 d-flex align-items-center flex-wrap mt-0">
                                        ...
                                        <div class="d-flex align-items-center mb-3 ms-2">
                                            ...
                                            <div class="d-flex flex-column ">
                                                <input type="text" name="Quo_No_CivilWork" class="form-control"
                                                    style="width: 180px;" value="{{ $blog->Quo_No_CivilWork }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center mb-3 ms-2">
                                            ...
                                            <div class="d-flex flex-column ">
                                                <input type="number" name="PR_Price_CivilWork" class="form-control"
                                        ...
                                        <div class="d-flex align-items-center mb-3 ms-2">
                                            ...
                                            <div class="flex-grow-1 position-relative">
                                                <input type="text" id="Accept_PR_Date_CivilWork"
                                                    name="Accept_PR_Date_CivilWork" class="form-control datepicker pe-5"
                                    ...
                                    <div class="col-md-3 d-flex align-items-center flex-wrap mt-0">
                                        ...
                                        <div class="d-flex align-items-center mb-3 ms-2">
                                            ...
                                            <div class="d-flex flex-column ">
                                                <input type="text" name="WO_No_CivilWork" class="form-control"
                                                    style="width: 180px;" value="{{ $blog->WO_No_CivilWork }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center mb-3 ms-2">
                                            ...
                                            <div class="d-flex flex-column ">
                                                <input type="number" name="WO_Price_CivilWork" class="form-control"
                                                    placeholder="กรุณากรอกตัวเลข"
                                        ...
                                        <div class="d-flex align-items-center mb-3 ms-2">
                                            ...
                                            <div class="d-flex flex-column">
                                                @php
                                                    ...
                                                    // แปลงค่าเป็นตัวเลขก่อนการคำนวณ
                                                    $accept_1st_CivilWork = floatval($blog->Accept_1st_CivilWork);
                                                    $accept_2nd_CivilWork = floatval($blog->Accept_2nd_CivilWork);
                                                    $accept_3rd_CivilWork = floatval($blog->Accept_3rd_CivilWork);
                                                    $accept_4th_CivilWork = floatval($blog->Accept_4th_CivilWork);
                                    ...
                                    <div class="col-md-7 d-flex align-items-center mt-4  ms-2">
                                        ...
                                        <div class="d-flex flex-column ">
                                            <input type="number" name="Accept_1st_CivilWork" class="form-control"
                                                style="width: 140px;" placeholder="กรุณากรอกตัวเลข"
                                        ...
                                        <div class="form-group mb-4 ms-2 ">
                                            ...
                                            <div class="position-relative">
                                                <input type="text" id="Mail_1st_CivilWork"
                                                    name="Mail_1st_CivilWork" class="form-control datepicker pe-5"
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            ...
                                            <div class="flex-grow-1 position-relative">
                                                <input type="text" id="ERP_1st_CivilWork" name="ERP_1st_CivilWork"
                                                    class="form-control datepicker pe-5" placeholder="วันที่-เดือน-ปี"
                                                    style="width: 140px;"
                                    ...
                                    <div class="col-md-7 d-flex align-items-center  ms-2">
                                        ...
                                        <div class="d-flex flex-column ">
                                            <input type="number" name="Accept_2nd_CivilWork" class="form-control"
                                                style="width: 140px;" placeholder="กรุณากรอกตัวเลข"
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            ...
                                            <div class="flex-grow-1 position-relative">
                                                <input type="text" id="Mail_2nd_CivilWork"
                                                    name="Mail_2nd_CivilWork" class="form-control datepicker pe-5"
                                                    placeholder="วันที่-เดือน-ปี" style="width: 140px;"
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="ERP_2nd_CivilWork" class="me-4"
                                                style="width: 120px;">ERP</label>
                                            <div class="flex-grow-1 position-relative">
                                                <input type="text" id="ERP_2nd_CivilWork" name="ERP_2nd_CivilWork"
                                                    class="form-control datepicker pe-5" placeholder="วันที่-เดือน-ปี"
                                                    style="width: 140px;"
                                    ...
                                    <div class="col-md-7 d-flex align-items-center  ms-2">
                                        ...
                                        <div class="d-flex flex-column ">
                                            <input type="number" name="Accept_3rd_CivilWork" class="form-control"
                                                style="width: 140px;" placeholder="กรุณากรอกตัวเลข"
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            ...
                                            <div class="flex-grow-1 position-relative">
                                                <input type="text" id="Mail_3rd_CivilWork"
                                                    name="Mail_3rd_CivilWork" class="form-control datepicker pe-5"
                                                    placeholder="วันที่-เดือน-ปี" style="width: 140px;"
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="ERP_3rd_CivilWork" class="me-4"
                                                style="width: 120px;">ERP</label>
                                            <div class="flex-grow-1 position-relative">
                                                <input type="text" id="ERP_3rd_CivilWork" name="ERP_3rd_CivilWork"
                                                    class="form-control datepicker pe-5" placeholder="วันที่-เดือน-ปี"
                                                    style="width: 140px;"
                                    ...
                                    <div class="col-md-7 d-flex align-items-center ms-2">
                                        ...
                                        <div class="d-flex flex-column ">
                                            <input type="number" name="Accept_4th_CivilWork" class="form-control"
                                                style="width: 140px;" placeholder="กรุณากรอกตัวเลข"
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            ...
                                            <div class="flex-grow-1 position-relative">
                                                <input type="text" id="Mail_4th_CivilWork"
                                                    name="Mail_4th_CivilWork" class="form-control datepicker pe-5"
                                                    placeholder="วันที่-เดือน-ปี" style="width: 140px;"
                                        ...
                                        <div class="form-group mb-4 ms-2">
                                            <label for="ERP_4th_CivilWork" class="me-4"
                                                style="width: 120px;">ERP</label>
                                            <div class="flex-grow-1 position-relative">
                                                <input type="text" id="ERP_4th_CivilWork" name="ERP_4th_CivilWork"
                                                    class="form-control datepicker pe-5" placeholder="วันที่-เดือน-ปี"
                                                    style="width: 140px;"
...
<!-- STATUS 2 -->                    
                ...
                <input type="hidden" name="Quotation_IN" value="{{ old('Quotation_IN', $blog->Quotation_IN) }}">
                <input type="hidden" name="PO_No_IN" value="{{ old('PO_No_IN', $blog->PO_No_IN) }}">
                <input type="hidden" name="PO_Amount_IN" value="{{ old('PO_Amount_IN', $blog->PO_Amount_IN) }}">
                <input type="hidden" name="Invoice1_IN" value="{{ old('Invoice1_IN', $blog->Invoice1_IN) }}">
                <input type="hidden" name="Amount1_IN" value="{{ old('Amount1_IN', $blog->Amount1_IN) }}">
                <input type="hidden" name="Invoice2_IN" value="{{ old('Invoice2_IN', $blog->Invoice2_IN) }}">
                <input type="hidden" name="Amount2_IN" value="{{ old('Amount2_IN', $blog->Amount2_IN) }}">
                
                
                <!-- TSSR -->
                <input type="hidden" name="AssignedSubCTSSR" value="{{ old('AssignedSubCTSSR', $blog->AssignedSubCTSSR) }}">
                <input type="hidden" name="PlanTSSR" value="{{ old('PlanTSSR', $blog->PlanTSSR) }}">
                <input type="hidden" name="ActualTSSR" value="{{ old('ActualTSSR', $blog->ActualTSSR) }}">
                <input type="hidden" name="SubName_TSSR" value="{{ old('SubName_TSSR', $blog->SubName_TSSR) }}">
                <input type="hidden" name="Quo_No_TSSR" value="{{ old('Quo_No_TSSR', $blog->Quo_No_TSSR) }}">
                <input type="hidden" name="PR_Price_TSSR" value="{{ old('PR_Price_TSSR', $blog->PR_Price_TSSR) }}">
                <input type="hidden" name="Accept_PR_Date_TSSR" value="{{ old('Accept_PR_Date_TSSR', $blog->Accept_PR_Date_TSSR) }}">
                <input type="hidden" name="WO_No_TSSR" value="{{ old('WO_No_TSSR', $blog->WO_No_TSSR) }}">
                <input type="hidden" name="WO_Price_TSSR" value="{{ old('WO_Price_TSSR', $blog->WO_Price_TSSR) }}">


                <input type="hidden" name="Accept_1st_TSSR" value="{{ old('Accept_1st_TSSR', $blog->Accept_1st_TSSR) }}">
                <input type="hidden" name="Mail_1st_TSSR" value="{{ old('Mail_1st_TSSR', $blog->Mail_1st_TSSR) }}">
                <input type="hidden" name="ERP_1st_TSSR" value="{{ old('ERP_1st_TSSR', $blog->ERP_1st_TSSR) }}">

                <input type="hidden" name="Accept_2nd_TSSR" value="{{ old('Accept_2nd_TSSR', $blog->Accept_2nd_TSSR) }}">
                <input type="hidden" name="Mail_2nd_TSSR" value="{{ old('Mail_2nd_TSSR', $blog->Mail_2nd_TSSR) }}">
                <input type="hidden" name="ERP_2nd_TSSR" value="{{ old('ERP_2nd_TSSR', $blog->ERP_2nd_TSSR) }}">

                <input type="hidden" name="Accept_3rd_TSSR" value="{{ old('Accept_3rd_TSSR', $blog->Accept_3rd_TSSR) }}">
                <input type="hidden" name="Mail_3rd_TSSR" value="{{ old('Mail_3rd_TSSR', $blog->Mail_3rd_TSSR) }}">
                <input type="hidden" name="ERP_3rd_TSSR" value="{{ old('ERP_3rd_TSSR', $blog->ERP_3rd_TSSR) }}">

                <input type="hidden" name="Accept_4th_TSSR" value="{{ old('Accept_4th_TSSR', $blog->Accept_4th_TSSR) }}">
                <input type="hidden" name="ERP_4th_TSSR" value="{{ old('ERP_4th_TSSR', $blog->ERP_4th_TSSR) }}">
                <input type="hidden" name="Banlace_TSSR" value="{{ old('Banlace_TSSR', $blog->Banlace_TSSR) }}">


                <!-- CIVIL WORK -->

                <input type="hidden" name="AssignSubCivilfoundation" value="{{ old('AssignSubCivilfoundation', $blog->AssignSubCivilfoundation) }}">
                <input type="hidden" name="PlanCivilWorkFoundation" value="{{ old('PlanCivilWorkFoundation', $blog->PlanCivilWorkFoundation) }}">
                <input type="hidden" name="ActualCivilWorkTower" value="{{ old('ActualCivilWorkTower', $blog->ActualCivilWorkTower) }}">
                <input type="hidden" name="AssignCivilWorkTower" value="{{ old('AssignCivilWorkTower', $blog->AssignCivilWorkTower) }}">
                <input type="hidden" name="PlanInstallationRectifier" value="{{ old('PlanInstallationRectifier', $blog->PlanInstallationRectifier) }}">
                <input type="hidden" name="ActualInstallationRectifier" value="{{ old('ActualInstallationRectifier', $blog->ActualInstallationRectifier) }}">
                <input type="hidden" name="PlanACPower" value="{{ old('PlanACPower', $blog->PlanACPower) }}">
                <input type="hidden" name="ActualACPower" value="{{ old('ActualACPower', $blog->ActualACPower) }}">
                <input type="hidden" name="PlanACMeter" value="{{ old('PlanACMeter', $blog->PlanACMeter) }}">

                <input type="hidden" name="ActualACMeter" value="{{ old('ActualACMeter', $blog->ActualACMeter) }}">
                ...
                <input type="hidden" name="Assigned_CivilWork" value="{{ old('Assigned_CivilWork', $blog->Assigned_CivilWork) }}">
                <input type="hidden" name="Plan_CivilWork" value="{{ old('Plan_CivilWork', $blog->Plan_CivilWork) }}">
                <input type="hidden" name="Actual_CivilWork" value="{{ old('Actual_CivilWork', $blog->Actual_CivilWork) }}">
                <input type="hidden" name="SubName_CivilWork" value="{{ old('SubName_CivilWork', $blog->SubName_CivilWork) }}">
                <input type="hidden" name="Quo_No_CivilWork" value="{{ old('Quo_No_CivilWork', $blog->Quo_No_CivilWork) }}">
                <input type="hidden" name="PR_Price_CivilWork" value="{{ old('PR_Price_CivilWork', $blog->PR_Price_CivilWork) }}">
                <input type="hidden" name="Accept_PR_Date_CivilWork" value="{{ old('Accept_PR_Date_CivilWork', $blog->Accept_PR_Date_CivilWork) }}">
                <input type="hidden" name="WO_No_CivilWork" value="{{ old('WO_No_CivilWork', $blog->WO_No_CivilWork) }}">
                <input type="hidden" name="WO_Price_CivilWork" value="{{ old('WO_Price_CivilWork', $blog->WO_Price_CivilWork) }}">

                <input type="hidden" name="Accept_1st_CivilWork" value="{{ old('Accept_1st_CivilWork', $blog->Accept_1st_CivilWork) }}">
                <input type="hidden" name="Mail_1st_CivilWork" value="{{ old('Mail_1st_CivilWork', $blog->Mail_1st_CivilWork) }}">
                <input type="hidden" name="ERP_1st_CivilWork" value="{{ old('ERP_1st_CivilWork', $blog->ERP_1st_CivilWork) }}">

                <input type="hidden" name="Accept_2nd_CivilWork" value="{{ old('Accept_2nd_CivilWork', $blog->Accept_2nd_CivilWork) }}">
                <input type="hidden" name="Mail_2nd_CivilWork" value="{{ old('Mail_2nd_CivilWork', $blog->Mail_2nd_CivilWork) }}">
                <input type="hidden" name="ERP_2nd_CivilWork" value="{{ old('ERP_2nd_CivilWork', $blog->ERP_2nd_CivilWork) }}">


                <input type="hidden" name="Accept_3rd_CivilWork" value="{{ old('Accept_3rd_CivilWork', $blog->Accept_3rd_CivilWork) }}">
                <input type="hidden" name="Mail_3rd_CivilWork" value="{{ old('Mail_3rd_CivilWork', $blog->Mail_3rd_CivilWork) }}">
                <input type="hidden" name="ERP_3rd_CivilWork" value="{{ old('ERP_3rd_CivilWork', $blog->ERP_3rd_CivilWork) }}">


                <input type="hidden" name="Accept_4th_CivilWork" value="{{ old('Accept_4th_CivilWork', $blog->Accept_4th_CivilWork) }}">
                <input type="hidden" name="Mail_4th_CivilWork" value="{{ old('Mail_4th_CivilWork', $blog->Mail_4th_CivilWork) }}">
                <input type="hidden" name="ERP_4th_CivilWork" value="{{ old('ERP_4th_CivilWork', $blog->ERP_4th_CivilWork) }}">
...
<!-- STATUS 3 -->   
                    ...
                    <!-- SAQ -->
                    <input type="hidden" name="AssignedSubCSurveySAQ" value="{{ old('AssignedSubCSurveySAQ', $blog->AssignedSubCSurveySAQ) }}">
                    <input type="hidden" name="SubName_SAQ" value="{{ old('SubName_SAQ', $blog->SubName_SAQ) }}">
                    <input type="hidden" name="PlanSurveySAQ" value="{{ old('PlanSurveySAQ', $blog->PlanSurveySAQ) }}">
                    <input type="hidden" name="ActualSurveySAQ" value="{{ old('ActualSurveySAQ', $blog->ActualSurveySAQ) }}">
                    <input type="hidden" name="Quo_No_SAQ" value="{{ old('Quo_No_SAQ', $blog->Quo_No_SAQ) }}">
                    <input type="hidden" name="PR_Price_SAQ" value="{{ old('PR_Price_SAQ', $blog->PR_Price_SAQ) }}">
                    <input type="hidden" name="Accept_PR_Date_SAQ" value="{{ old('Accept_PR_Date_SAQ', $blog->Accept_PR_Date_SAQ) }}">
                    <input type="hidden" name="WO_No_SAQ" value="{{ old('WO_No_SAQ', $blog->WO_No_SAQ) }}">
                    <input type="hidden" name="WO_Price_SAQ" value="{{ old('WO_Price_SAQ', $blog->WO_Price_SAQ) }}">


                    <input type="hidden" name="Accept_1st_SAQ" value="{{ old('Accept_1st_SAQ', $blog->Accept_1st_SAQ) }}">
                    <input type="hidden" name="Mail_1st_SAQ" value="{{ old('Mail_1st_SAQ', $blog->Mail_1st_SAQ) }}">
                    <input type="hidden" name="ERP_1st_SAQ" value="{{ old('ERP_1st_SAQ', $blog->ERP_1st_SAQ) }}">

                    <input type="hidden" name="Accept_2nd_SAQ" value="{{ old('Accept_2nd_SAQ', $blog->Accept_2nd_SAQ) }}">
                    <input type="hidden" name="Mail_2nd_SAQ" value="{{ old('Mail_2nd_SAQ', $blog->Mail_2nd_SAQ) }}">
                    <input type="hidden" name="ERP_2nd_SAQ" value="{{ old('ERP_2nd_SAQ', $blog->ERP_2nd_SAQ) }}">

                    <input type="hidden" name="Accept_3rd_SAQ" value="{{ old('Accept_3rd_SAQ', $blog->Accept_3rd_SAQ) }}">
                    <input type="hidden" name="Mail_3rd_SAQ" value="{{ old('Mail_3rd_SAQ', $blog->Mail_3rd_SAQ) }}">
                    <input type="hidden" name="ERP_3rd_SAQ" value="{{ old('ERP_3rd_SAQ', $blog->ERP_3rd_SAQ) }}">

                    <input type="hidden" name="Accept_4th_SAQ" value="{{ old('Accept_4th_SAQ', $blog->Accept_4th_SAQ) }}">
                    <input type="hidden" name="Mail_4th_SAQ" value="{{ old('Mail_4th_SAQ', $blog->Mail_4th_SAQ) }}">
                    <input type="hidden" name="ERP_4th_SAQ" value="{{ old('ERP_4th_SAQ', $blog->ERP_4th_SAQ) }}">


                    <!-- CR -->

                    <input type="hidden" name="AssignedSubCCR" value="{{ old('AssignedSubCCR', $blog->AssignedSubCCR) }}">
                    <input type="hidden" name="SubName_CR" value="{{ old('SubName_CR', $blog->SubName_CR) }}">
                    ...
                    <input type="hidden" name="PR_Price_CR" value="{{ old('PR_Price_CR', $blog->PR_Price_CR) }}">
                    <input type="hidden" name="Accept_PR_Date_CR" value="{{ old('Accept_PR_Date_CR', $blog->Accept_PR_Date_CR) }}">
                    <input type="hidden" name="WO_No_CR" value="{{ old('WO_No_CR', $blog->WO_No_CR) }}">
                    <input type="hidden" name="WO_Price_CR" value="{{ old('WO_Price_CR', $blog->WO_Price_CR) }}">

                    <input type="hidden" name="Accept_1st_CR" value="{{ old('Accept_1st_CR', $blog->Accept_1st_CR) }}">
                    <input type="hidden" name="Mail_1st_CR" value="{{ old('Mail_1st_CR', $blog->Mail_1st_CR) }}">
                    <input type="hidden" name="ERP_1st_CR" value="{{ old('ERP_1st_CR', $blog->ERP_1st_CR) }}">

                    <input type="hidden" name="Accept_2nd_CR" value="{{ old('Accept_2nd_CR', $blog->Accept_2nd_CR) }}">
                    <input type="hidden" name="Mail_2nd_CR" value="{{ old('Mail_2nd_CR', $blog->Mail_2nd_CR) }}">
                    <input type="hidden" name="ERP_2nd_CR" value="{{ old('ERP_2nd_CR', $blog->ERP_2nd_CR) }}">

                    <input type="hidden" name="Accept_3rd_CR" value="{{ old('Accept_3rd_CR', $blog->Accept_3rd_CR) }}">
                    <input type="hidden" name="Mail_3rd_CR" value="{{ old('Mail_3rd_CR', $blog->Mail_3rd_CR) }}">
                    <input type="hidden" name="ERP_3rd_CR" value="{{ old('ERP_3rd_CR', $blog->ERP_3rd_CR) }}">

                    <input type="hidden" name="Accept_4th_CR" value="{{ old('Accept_4th_CR', $blog->Accept_4th_CR) }}">
                    <input type="hidden" name="Mail_4th_CR" value="{{ old('Mail_4th_CR', $blog->Mail_4th_CR) }}">
                    <input type="hidden" name="ERP_4th_CR" value="{{ old('ERP_4th_CR', $blog->ERP_4th_CR) }}">
                ...
                <script>
                    $(document).ready(function() {
                        $('.datepicker').datepicker({
                            ...
                            todayHighlight: true,
                            clearBtn: true,
                            startDate: '01-01-2000', // เริ่มวันที่ 1 มกราคม ค.ศ. 2000ภ
